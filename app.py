...
st.set_page_config(
    page_title='Absenteeism at Work Forecasting Forecasting App', 
    page_icon = im, 
    layout = 'wide', 
...
st.sidebar.title('Absenteeism at Work Forecasting')
st.sidebar.write('---')

st.write("""
# Absenteeism at Work Forecasting

Absenteeism at Work Forecasting **provides 30 days forecast of absenteeism using historical daily absenteeism data.**
""")
st.write('---')
...
if st.sidebar.button('Prediction'):
    ...
    st.header('Absenteeism at Work  Forecast')
